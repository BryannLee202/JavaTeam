...
| **UC-10** | Phan cong Mentor huong dan cho Hang muc | Ban to chuc (Coordinator) | Done | TrackController.java | TrackService.java | TrackServiceTest.java | JudgesMentorsTab.tsx |
...
| **UC-19** | Xu ly vi pham va loai doi thi / bai nop | Ban to chuc (Coordinator) | Done | DisqualificationController.java | DisqualificationService.java | HackathonBackendApplicationTests.java | DisqualificationsTab.tsx |
| **UC-20** | Ghi va truy van nhat ky kiem tra (Audit Log) | Ban to chuc (Coordinator) | Done | AuditLogController.java | AuditLogQueryService.java | HackathonBackendApplicationTests.java | AuditLogPage.tsx |
...
| **UC-25** | Cau hinh va trao giai thuong theo xep hang | Ban to chuc (Coordinator) | Done | PrizeController.java | PrizeService.java | HackathonBackendApplicationTests.java | PrizesTab.tsx |
| **UC-26** | Cong bo ket qua va binh chon truc tuyen cong khai | Cong chung / Khach tham quan | Done | PublicRankingController.java | PublicVotingService.java | RankingControllerTest.java | RankingPage.tsx |
